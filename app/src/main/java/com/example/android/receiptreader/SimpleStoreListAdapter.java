...
public class SimpleStoreListAdapter extends ArrayAdapter<Store> {
    public SimpleStoreListAdapter(@NonNull Context context, ArrayList<Store> stores) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(newItemView == null) {
            newItemView = LayoutInflater.from(getContext()).inflate(R.layout.simple_store_item, parent, false);
        }
