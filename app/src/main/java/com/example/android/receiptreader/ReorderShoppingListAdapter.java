...
public class ReorderShoppingListAdapter extends ArrayAdapter<ShoppingList> {
    ArrayList<ShoppingList> shoppingLists;
    public ReorderShoppingListAdapter(@NonNull Context context, ArrayList<ShoppingList> shoppingLists) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(newItemView == null) {
            newItemView = LayoutInflater.from(getContext()).inflate(R.layout.reorder_shopping_list, parent, false);
        }
